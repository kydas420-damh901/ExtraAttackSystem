...
namespace ExtraAttackSystem
{
    ...
    [HarmonyPatch(typeof(Humanoid), nameof(Humanoid.StartAttack), new Type[] { typeof(Character), typeof(bool) })]
    ...
    internal static class EAS_StartAttack_ClearPrevOnNormal_Prefix
    {
        ...
        private static void Prefix(Humanoid __instance, Character target, bool secondaryAttack)
        {
            try
            {
